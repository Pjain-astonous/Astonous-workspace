...
export default class List extends LightningElement {
  ...
  handleMessage (message) {
    ...
    if (message.contactId) {
      ...
      console.log('contatc', this.value)
    }
    if (message.search) {
  ...
  wiredobj (value) {
    ...
    if (data) {
      ...
      console.log('endrec...', this.endRec)
    } else if (error) {
      console.log('An error has occurred:')
  ...
  updateItemPage () {
    ...
    this.items = [...copydata]
    console.log('handleritem', this.items)
  }
  handleChildChange (childEvent) {
    console.log(childEvent.detail.showadd)
    console.log(childEvent.detail.showDelete)
  ...
  handleRemove (event) {
    ...
    copydata.forEach(items => {
      if (items.Id === event.detail.QtyId) {
        console.log('ajabhai' + event.detail.Delval)
